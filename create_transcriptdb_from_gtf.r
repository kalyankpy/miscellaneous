...
gencodev19db<-makeTranscriptDbFromGFF("/home/kalyankpy/Downloads/gencode.v19.annotation_2.gtf", 
...
saveDb(gencodev19db, file="/home/kalyankpy/reg_elements/gencode_human_v19.sqlite")
